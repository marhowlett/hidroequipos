...
<section id="staff2" class="template-section">
    <div class="contenedor">
	 ...
	 <div class="col2"><a href="https://webmail.hidroequipos.com/cpsess0498961472/horde/imp/dynamic.php?page=mailbox#mbox:SU5CT1g"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/web.png" alt="pool">
                    <h3>WEB MAIL</h3>
	
		 
		 <div class="col2"><a href="http://avl.telenube.net/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/gps.png" alt="Pool">
                    <h3>GPS</h3>			
                </a></div>
